...
int ThreadedPollerModule::register_handler(const struct PollerStruct &poller_str, const std::function<int(int)>& function_name) {
...
int ThreadedPollerModule::sampleFunction(int a) {
    return 0;
}
